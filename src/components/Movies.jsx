        ...
        <div className="basis-2/3">
          ...
          <div className="flex flex-wrap p-1 lg:p-0  ">
            {MoviesData?.map(({ id, name, description, image }) => (
              <div
                key={id}
                className="group relative overflow-hidden basis-1/2 lg:basis-1/3"
              >
                <img
                  src={image}
                  alt="logo"
        ...
        <div className="basis-1/3">
          ...
          <div className="flex flex-row lg:flex-col lg:h-full justify-start flex-wrap lg:flex-nowrap space-y-4 lg:justify-between lg:pb-24 pl-4 ">
            {HotNews.slice(0, 6).map(({ id, image, description, date }) => (
              <div
                className="flex items-center group basis-full md:basis-1/2"
                key={id}
              >
                ...
                <div className="pl-8 basis-2/3 text-clr-grey group-hover:text-clr-melon group-hover:cursor-pointer duration-500">
                  ...
                  <p className="uppercase text-sm tracking-tighter mt-2 font-bold font-gemunu">
                    ON Now {date}
                  </p>
                </div>
              </div>
